...
// PG_GYRO_CONFIG
    ...
    { "dyn_dterm_lpf_enable",       VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, dyn_dterm_lpf_enable) },
    ...
    { "dyn_dterm_lpf_max_hz",       VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 0, 1000 }, PG_PID_PROFILE, offsetof(pidProfile_t, dyn_dterm_lpf_max_hz) },
    { "dyn_dterm_lpf_idle",         VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 0, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, dyn_dterm_lpf_idle) },
