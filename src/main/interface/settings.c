...
// PG_GYRO_CONFIG
    ...
    { "gyro_notch1_hz_roll",        VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 16000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_notch_hz_1_roll) },
    { "gyro_notch1_cutoff_roll",    VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 16000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_notch_cutoff_1_roll) },
    { "gyro_notch1_hz_pitch",       VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 16000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_notch_hz_1_pitch) },
    { "gyro_notch1_cutoff_pitch",   VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 16000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_notch_cutoff_1_pitch) },
    ...
    { "dyn_gyro_lpf_enable",        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_gyro_lpf_enable) },
    { "dyn_dterm_lpf_enable",       VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_dterm_lpf_enable) },
    { "dyn_gyro_lpf_max_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_gyro_lpf_max_hz) },
    { "dyn_gyro_lpf_min_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_gyro_lpf_min_hz) },
    { "dyn_gyro_lpf_idle",              VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 100 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_gyro_lpf_idle) },
